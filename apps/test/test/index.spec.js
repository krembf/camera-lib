...
describe('addon', function () {
  it('should have all expected keys', function () {
    expect(addon).to.contain.all.keys(['GetCameraName', 'Snap', 'add'])
  })
  ...
  describe('.SnapAsync', function () {
    ...
    //   addon.SnapAsync(function (err, buffer) {
    //     expect(err).to.not.exist
    //     // fake, not working right now
    //     expect(buffer).to.equal(42)
    //     done()
    //   })
    // }) 
  ...
  describe('.add', function () {
    ...
    it('should add numbers together', function (done) {
      ...
      var expectedCount = 0
      var actualCount = 0
      var sumCheckerFn = function (sumExpected) {
        expectedCount++
